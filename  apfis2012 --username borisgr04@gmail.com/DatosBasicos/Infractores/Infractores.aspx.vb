Imports System.Data
Partial Class DatosBasicos_Infractores_Default
    Inherits PaginaComun

    Dim Obj As New Infractores
        ...
        Select Case Me.Oper
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCed.Text = tb.Rows(0)("Ced_Inf").ToString
                    Me.TxtApe1.Text = tb.Rows(0)("Ape1_Inf").ToString
                    Me.TxtApe2.Text = tb.Rows(0)("Ape2_Inf").ToString
                    Me.TxtNom.Text = tb.Rows(0)("Nom_Inf").ToString
                    Me.TxtExp.Text = tb.Rows(0)("Exp_Ced_Inf").ToString
                    Me.TxtDir.Text = tb.Rows(0)("Dir_Inf").ToString
                    Me.TxtTel.Text = tb.Rows(0)("Tel_Inf").ToString
                    Me.TxtCor.Text = tb.Rows(0)("Cor_Inf").ToString

                    Me.Pk1 = tb.Rows(0)("Ced_Inf").ToString
                    Me.ModalPopupTer.Show()
