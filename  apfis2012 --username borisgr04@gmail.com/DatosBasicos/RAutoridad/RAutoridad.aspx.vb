Imports System.Data
Partial Class DatosBasicos_RAutoridad_Default
    Inherits PaginaComun

    Dim Obj As New RAutoridad
        ...
        Select Case Me.Oper
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCed.Text = tb.Rows(0)("Ced_Aut").ToString
                    Me.TxtApe1.Text = tb.Rows(0)("Ape1_Aut").ToString
                    Me.TxtApe2.Text = tb.Rows(0)("Ape2_Aut").ToString
                    Me.TxtNom.Text = tb.Rows(0)("Nom_Aut").ToString
                    Me.TxtExp.Text = tb.Rows(0)("Exp_Ced_Aut").ToString
                    Me.TxtDir.Text = tb.Rows(0)("Dir_Aut").ToString
                    Me.TxtTel.Text = tb.Rows(0)("Tel_Aut").ToString
                    Me.TxtCor.Text = tb.Rows(0)("Cor_Aut").ToString

                    Me.Pk1 = tb.Rows(0)("Ced_Aut").ToString
                    Me.ModalPopupTer.Show()
