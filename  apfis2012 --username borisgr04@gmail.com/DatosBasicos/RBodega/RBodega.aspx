<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RBodega.aspx.vb" Inherits="DatosBasicos_RBodega_Default
" %>
...
&nbsp;<asp:Label id="Tit" runat="server" Width="368px" CssClass="Titulo" 
                Text="REPRESENTANTES DE BODEGA"></asp:Label><BR /><asp:Label id="MsgResult" 
                ...
                OnRowCommand="GridView1_RowCommand" DataKeyNames="Ced_Bod" 
...
<Columns>
<asp:TemplateField HeaderText="Cedula" SortExpression="Ced_Bod"><FooterTemplate>
...
<ItemTemplate>
<asp:Label id="LbCod" runat="server" Text='<%# Bind("Ced_Bod") %>' __designer:wfdid="w9"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField HeaderText="Primer Apellido" SortExpression="Ape1_Bod"><ItemTemplate>
<asp:Label id="Lbcimp" runat="server" Text='<%# Bind("Ape1_Bod") %>' __designer:wfdid="w21"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
    <asp:BoundField DataField="Ape2_Bod" HeaderText="Segundo Apellido" 
        SortExpression="Ape2_Bod" />
    <asp:BoundField DataField="Nom_Bod" HeaderText="Nombres" 
        SortExpression="Nom_Bod" />
    <asp:BoundField DataField="Exp_Ced_Bod" HeaderText="Expedida en" 
        SortExpression="Exp_Ced_Bod" />
    ...
    <asp:BoundField DataField="Cor_Bod" DataFormatString="{0:c}" 
        HeaderText="Correo" SortExpression="Cor_Bod" >
...
<AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>
            ...
            <asp:ObjectDataSource id="ObjTipos" runat="server" TypeName="RBodega" 
                ...
                <UpdateParameters>
                    ...
                    <asp:Parameter Name="Tel_Inf" Type="String" />
                    <asp:Parameter Name="Cor_Inf" Type="String" />
                    <asp:Parameter Name="CedPK" Type="String" />
                </UpdateParameters>
