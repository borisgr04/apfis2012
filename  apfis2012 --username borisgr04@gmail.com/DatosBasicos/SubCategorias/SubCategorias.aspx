...
&nbsp;<asp:Label id="Tit" runat="server" Width="286px" CssClass="Titulo" 
                Text="sUBCategorias"></asp:Label><BR /><asp:Label id="MsgResult" 
                ...
                OnRowCommand="GridView1_RowCommand" DataKeyNames="Cod_SCat" 
...
<ItemTemplate>
<asp:Label id="LbCod" runat="server" Text='<%# Bind("Cod_SCat") %>' __designer:wfdid="w9"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField HeaderText="Nombre de la SubCategoria" SortExpression="Nom_Cat"><ItemTemplate>
<asp:Label id="Lbcimp" runat="server" Text='<%# Bind("Des_SCat") %>' __designer:wfdid="w21"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
...
<AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>
            ...
            <asp:ObjectDataSource id="ObjTipos" runat="server" TypeName="SubCategorias" 
            ...
            <TD style="WIDTH: 100px; HEIGHT: 23px">
                    ...
                    <TR><TD style="WIDTH: 98px">
                        <asp:Label ID="Label5" runat="server" Text="Categoria" Width="126px"></asp:Label>
                            ...
                            <asp:DropDownList ID="CmbCategoria" runat="server" Height="19px" Width="148px" 
        ...
        <TR><TD style="WIDTH: 98px">
            ...
            <TD style="WIDTH: 100px">
                <asp:DropDownList ID="CmbFondo" runat="server" DataSourceID="ObjFondo" 
                    DataTextField="Nom_Tip" DataValueField="Cod_Tip" Height="19px" Width="148px">
                </asp:DropDownList>
