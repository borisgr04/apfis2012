Imports System.Data
Partial Class DatosBasicos_SubCategorias_Default
    Inherits PaginaComun

    Dim Obj As New SubCategorias
        ...
        Select Case Me.Oper
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("Cod_SCat").ToString
                    Me.txtNomNew.Text = tb.Rows(0)("Des_SCat").ToString
                    Me.TxtCodAnt.Text = tb.Rows(0)("Cod_Scat_Ant").ToString
                    Me.CmbCategoria.SelectedValue = tb.Rows(0)("Cod_Cat").ToString
                    If tb.Rows(0)("Cod_Fnd").ToString <> "" Then
                        Me.CmbFondo.SelectedValue = tb.Rows(0)("Cod_Fnd").ToString
                    End If
                    Me.TxtCodAnt.Visible = False
                    Me.Label7.Visible = False
                    Me.Pk1 = tb.Rows(0)("Cod_SCat").ToString
                    Habilitar(True)
                    Me.ModalPopupTer.Show()
                End If
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.CmbCategoria.SelectedValue, Me.TxtCodNew.Text, Me.txtNomNew.Text, Me.TxtCodAnt.Text, Me.CmbFondo.SelectedValue)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Me.CmbCategoria.SelectedValue, Me.TxtCodNew.Text, Me.txtNomNew.Text, Me.TxtCodAnt.Text, Me.CmbFondo.SelectedValue, Me.Pk1)
        End Select
