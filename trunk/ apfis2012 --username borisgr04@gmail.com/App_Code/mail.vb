...
Public Class Mail
    ...
    Public Shared Function EnviarNot(ByVal Para As String, ByVal asunto As String, ByVal cuerpo As String, Optional ByVal CC As String = "", Optional ByVal BCC As String = "") As String
