...
Partial Class Consultas_FondoV2_RptFondo
    ...
    Protected Sub Page_Load1(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Me.txtfecini.Text = Now.ToShortDateString
            Me.TxtFecFin.Text = Now.AddMonths(-1).ToShortDateString
        End If
    End Sub
    ...
    Protected Sub IBtnExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles IBtnExcel.Click
        ...
        Dim dtSource As ReportDataSource = New ReportDataSource("DsActas_DsFondo", dt)
