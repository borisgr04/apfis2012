...
<TABLE style="WIDTH: 641px"><TBODY>
    ...
    <TR><TD style="WIDTH: 108px">Número&nbsp; Identificación<asp:RequiredFieldValidator 
    ...
    <tr>
        ...
        <td style="WIDTH: 46px" colspan="4">
            E-Mail</td>
        <td colspan="3">
            <asp:TextBox ID="TxtEma" runat="server" ValidationGroup="Guardar" Width="190px"></asp:TextBox>
        </td>
    </tr>
    <tr>
