Imports System.Data
Partial Class DatosBasicos_Bodegas_Default
        ...
        Select Case Me.Oper
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("Cod_Bod").ToString
                    Me.txtNomNew.Text = tb.Rows(0)("Nom_Bod").ToString
                    Me.TxtCor.Text = tb.Rows(0)("Ema_Bod").ToString
                    Me.TxtDir.Text = tb.Rows(0)("Dir_Bod").ToString
                    Me.TxtTel.Text = tb.Rows(0)("Tel_Bod").ToString
                    Me.CmbEst.SelectedValue = tb.Rows(0)("Est_Bod").ToString()
                    Me.CmbMuni.SelectedValue = tb.Rows(0)("Cod_Mun").ToString

                    Me.Pk1 = tb.Rows(0)("Cod_Bod").ToString
                    Me.ModalPopupTer.Show()
                    Habilitar(True)
                End If
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.txtNomNew.Text, Me.TxtDir.Text, Me.TxtCodNew.Text, Me.TxtTel.Text, Me.TxtCor.Text, Me.CmbMuni.SelectedValue, Me.CmbEst.SelectedValue)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Me.txtNomNew.Text, Me.TxtDir.Text, Me.TxtCodNew.Text, Me.TxtTel.Text, Me.TxtCor.Text, Me.CmbMuni.SelectedValue, Me.CmbEst.SelectedValue, Me.Pk1)
        End Select
