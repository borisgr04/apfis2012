<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RAutoridad.aspx.vb" Inherits="DatosBasicos_RAutoridad_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="demoarea">
        ...
        <contenttemplate>
&nbsp;<asp:Label id="Tit" runat="server" Width="368px" CssClass="Titulo" 
                Text="aUTORIDAD RETENEDORA"></asp:Label><BR /><asp:Label id="MsgResult" 
                ...
                OnRowCommand="GridView1_RowCommand" DataKeyNames="Ced_Aut" 
...
<Columns>
<asp:TemplateField HeaderText="Cedula" SortExpression="Ced_Aut"><FooterTemplate>
...
<ItemTemplate>
<asp:Label id="LbCod" runat="server" Text='<%# Bind("Ced_Aut") %>' __designer:wfdid="w9"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField HeaderText="Primer Apellido" SortExpression="Ape1_Aut"><ItemTemplate>
<asp:Label id="Lbcimp" runat="server" Text='<%# Bind("Ape1_Aut") %>' __designer:wfdid="w21"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
    <asp:BoundField DataField="Ape2_Aut" HeaderText="Segundo Apellido" 
        SortExpression="Ape2_Aut" />
    <asp:BoundField DataField="Nom_Aut" HeaderText="Nombres" 
        SortExpression="Nom_Aut" />
    <asp:BoundField DataField="Exp_Ced_Aut" HeaderText="Expedida en" 
        SortExpression="Exp_Ced_Aut" />
    <asp:BoundField DataField="Dir_Aut" HeaderText="Direccion" 
        SortExpression="Dir_Aut" />
    <asp:BoundField DataField="Tel_Aut" HeaderText="Telefono" 
        SortExpression="Tel_Aut" />
    <asp:BoundField DataField="Cor_Aut" DataFormatString="{0:c}" 
        HeaderText="Correo" SortExpression="Cor_Aut" >
...
<AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>
            ...
            <asp:ObjectDataSource id="ObjTipos" runat="server" TypeName="RAutoridad" 
